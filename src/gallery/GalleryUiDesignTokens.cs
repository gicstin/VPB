namespace VPB
{
    ...
    public static class GalleryUiDesignTokens
    {
        ...
        // Title bar
        public const float TitleBarHeightRef = 70f;
        public const float TitleBarChipRef = 40f;
        public const float TitleBarCategoryRowHeightRef = 44f;
        ...
        public const float SearchClearBtnSizeRef = 40f;
        ...
        public const float ResizeHandleTitleCenterYRef = 35f;   // title bar half-height (top corners)
        ...
        public const float SideTabRowHeightRef = 35f;
        public const float SideTabControlGapRef = 5f;
        public const float SideTabRefreshBtnWidthRef = 40f;
        ...
        public const float FooterBarHeightRef = 60f;
        public const float FooterInfoRowHeightRef = 60f;
        public const float FooterToolboxTopRef = 120f;
        public const float FilterChipRowHeightRef = 32f;
        ...
        public const float SideButtonHeightRef = 50f;
        public const float SideButtonSquareRef = 50f;
        public const float SideButtonContainerWidthRef = 130f;
        public const float SideButtonContainerOffsetRef = 140f;
        public const float SideButtonSpacingRef = 60f;
        ...
        public const float ImportSidebarApplyHeightRef = 30f;
        ...
        public const float ImportSidebarRowHeightRef = 35f;
        ...
        public const float InAppHelpNavBtnHeightRef = 38f;
        ...
        public const float PopupMenuRowHeightRef = 36f;
        public const float PopupMenuRowHeightCompactRef = 34f;
        ...
        public const float TboxActionButtonSizeRef = 44f;

        // Toolbox pin + in-app help close
        public const float TboxPinBtnSizeRef = 44f;
        public const float InAppHelpCloseBtnSizeRef = 36f;
        ...
        public const float SideTabTopOffsetRef = 65f;
