...
namespace VPB
{
    ...
    internal static partial class VpbLocalDatabase
    {
        ...
        /// <summary>One gallery item with tags for bulk import/migration.</summary>
        ...
        /// <summary>Retrieves category membership for a single gallery item.</summary>
        ...
        /// <summary>Remove user tags from a gallery item.</summary>
