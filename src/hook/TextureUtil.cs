...
namespace VPB
{
    public static class TextureUtil
    {
        ...
        public static long GetFileEntryCacheSizeToken(MVR.FileManagement.FileEntry fileEntry, string imgPath = null)
        {
            ...
            if (!string.IsNullOrEmpty(imgPath))
            {
                try
                {
                    ...
                    VarFileEntry vfe = vpbEntry as VarFileEntry;
        ...
        private static bool VaMNativeCacheFilePairExists(string cachePath)
        {
            ...
            try
            {
                if (MVR.FileManagement.FileManager.FileExists(cachePath)
                    && MVR.FileManagement.FileManager.FileExists(cachePath + "meta"))
                {
                    return true;
                }
            }
            ...
            out string sig)
        {
            ...
            sizeStr = GetFileEntryCacheSizeToken(fileEntry, imgPath).ToString();
