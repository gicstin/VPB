...
3. For typed messages from VPB, enable Voice Wizard's **OSC listener**.
...
3. Open **Speech** in the multiplayer panel and click **Enable speech**.
...
Click **Stop sharing** for voice and turn **STT captions** off for text. Disable speech or leave the room to stop both. **Closing the panel does not stop sharing.**
